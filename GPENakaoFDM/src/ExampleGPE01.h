...
template<typename T>
long double ExampleGPE01<T>::d2a1dx2(const long double& x, const long double& y)
{
	return 0.0;
}

template<typename T>
long double ExampleGPE01<T>::d2a1dy2(const long double& x, const long double& y)
{
	return 0.0;
}
...
template<typename T>
long double ExampleGPE01<T>::d2a2dx2(const long double& x, const long double& y)
{
	return 0.0;
}

template<typename T>
long double ExampleGPE01<T>::d2a2dy2(const long double& x, const long double& y)
{
	return 0.0;
}

template<typename T>
Interval<T> ExampleGPE01<T>::F(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	//f(x,y)= 0;
	Interval<T> r;
	r.a = 0;
...
template<typename T>
Interval<T> ExampleGPE01<T>::PSI(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	//psi(x,y) = 0
...
template<typename T>
Interval<T> ExampleGPE01<T>::OMEGA(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	//omega(x,y) = 0
	Interval<T> r =
	{ 0, 0 };
...
template<typename T>
Interval<T> ExampleGPE01<T>::PSI1(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	Interval<T> r =
	{ 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE01<T>::PSI2(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	Interval<T> r =
	{ 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE01<T>::PSI3(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	Interval<T> r =
	{ 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE01<T>::PSI4(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	Interval<T> r =
	{ 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE01<T>::A(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	// a(x,y) = 1.0;
	Interval<T> ione =
	{ 1, 1 };
...
template<typename T>
Interval<T> ExampleGPE01<T>::C(const Interval<T>& ix, const Interval<T>& iy, int& st)
{
	//c(x,y) = 1.0;
	Interval<T> ione =
	{ 1, 1 };
...
template<typename T>
int ExampleGPE01<T>::boundconds_classic(const long double& b1, const long double& b2,
		const long double eps)
{
	if ((b1 != 0) && (b2 != 0))
	{
