...
#ifndef EXAMPLEGPE07_H_
#define EXAMPLEGPE07_H_
...
template<typename T>
class ExampleGPE07: public BoundaryConditions<T> {
	const long double PI = 3.141592653589793238L;
public:
	ExampleGPE07();
	virtual ~ExampleGPE07();
...
template<typename T>
long double ExampleGPE07<T>::f(const long double& x, const long double& y) {

	//2*sin(pi*x*y)
	return 2.0*sin(PI*x*y);
}

template<typename T>
long double ExampleGPE07<T>::phi1(const long double& y) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::phi2(const long double& x) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::phi3(const long double& y) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::phi4(const long double& x) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::c(const long double& x, const long double& y) {
	return PI*PI*(x*x+y*y) + 2.0;
}

template<typename T>
long double ExampleGPE07<T>::dcdx(const long double& x, const long double& y) {
	//2.0*PI*PI*x;
	return 2.0*PI*PI*x;
}

template<typename T>
long double ExampleGPE07<T>::dcdy(const long double& x, const long double& y) {
	//return 2.0*PI*PI*y;
	return 2.0*PI*PI*y;
}

template<typename T>
long double ExampleGPE07<T>::d2cdx2(const long double& x, const long double& y) {
	//2.0*PI*PI;
	return 2.0*PI*PI;
}

template<typename T>
long double ExampleGPE07<T>::d2cdy2(const long double& x, const long double& y) {
	//return 2.0*PI*PI;
	return 2.0*PI*PI;
}

template<typename T>
long double ExampleGPE07<T>::a1(const long double& x, const long double& y) {
	return 1.0;
}

template<typename T>
long double ExampleGPE07<T>::d2a1dx2(const long double& x,
		const long double& y) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::d2a1dy2(const long double& x,
		const long double& y) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::a2(const long double& x, const long double& y) {
	return 1.0;
}

template<typename T>
long double ExampleGPE07<T>::d2a2dx2(const long double& x,
		const long double& y) {
	return 0.0;
}

template<typename T>
long double ExampleGPE07<T>::d2a2dy2(const long double& x,
		const long double& y) {
	return 0.0;
}

template<typename T>
Interval<T> ExampleGPE07<T>::F(const Interval<T>& ix, const Interval<T>& iy,
...
template<typename T>
Interval<T> ExampleGPE07<T>::PHI1(const Interval<T>& iy, int& st) {
	//phi1(y) = 0.0;
	Interval<T> r = { 0, 0 };
...
template<typename T>
Interval<T> ExampleGPE07<T>::PHI2(const Interval<T>& ix, int& st) {
	//phi2(x) = 0.0;
	Interval<T> r = { 0, 0 };
...
template<typename T>
Interval<T> ExampleGPE07<T>::PHI3(const Interval<T>& iy, int& st) {
	//phi3(y) = 0.0;
	Interval<T> r = { 0, 0 };
...
template<typename T>
Interval<T> ExampleGPE07<T>::PHI4(const Interval<T>& ix, int& st) {
	//phi3(y) = 0.0;
	Interval<T> r = { 0, 0 };
	st = 0;
	return r;
...
template<typename T>
Interval<T> ExampleGPE07<T>::PSI(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	//psi(x,y) = 0
	Interval<T> r = { 0, 0 };
...
template<typename T>
Interval<T> ExampleGPE07<T>::OMEGA(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	//omega(x,y) = 0
	Interval<T> r = { 0, 0 };
...
template<typename T>
Interval<T> ExampleGPE07<T>::PSI1(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE07<T>::PSI2(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE07<T>::PSI3(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE07<T>::PSI4(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
Interval<T> ExampleGPE07<T>::C(const Interval<T>& ix, const Interval<T>& iy,
		int& st) {
	//c(x,y) = PI*PI*(x*x+y*y) + 2.0;
	return ipi *ipi * (ix*ix + iy*iy) + i2;
}

template<typename T>
long double ExampleGPE07<T>::ExactSol(long double x, long double y) {
...
template<typename T>
long double ExampleGPE07<T>::GetConstM() {
...
template<typename T>
long double ExampleGPE07<T>::GetConstN() {
...
template<typename T>
long double ExampleGPE07<T>::GetConstP() {
...
template<typename T>
long double ExampleGPE07<T>::GetConstQ() {
...
template<typename T>
long double ExampleGPE07<T>::GetConstR() {
...
template<typename T>
long double ExampleGPE07<T>::GetConstS() {
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::A1(const Interval<T>& ix,
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::A2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = i1;
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::D2A1DX2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::D2A1DY2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::D2A2DX2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::D2A2DY2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DCDX(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
	r = i2*PI*PI*ix;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DCDY(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
	r = i2*PI*PI*iy;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DFDX(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DFDY(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::D2FDX2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::D2FDY2(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DA1DX(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DA1DY(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DA2DX(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
inline Interval<T> ExampleGPE07<T>::DA2DY(const Interval<T>& ix,
		const Interval<T>& iy, int& st) {
	Interval<T> r = { 0, 0 };
	st = 0;
...
template<typename T>
void ExampleGPE07<T>::SetArithmeticMode(IAMode mode) {
	Interval<T>::SetMode(mode);
}

template<typename T>
int ExampleGPE07<T>::boundconds_classic(const long double& b1,
